  ...
  return (
    <>
      <div className="flex justify-between mb-5 py-2">
        <p className='text-[24px] font-semibold text-[#000000] font-jakarta'>Notification</p>
      </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-[16px] w-[763px] h-auto p-6 relative shadow-lg">
            ...
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-[16px] font-semibold text-[#000000] font-jakarta">Add Notification</h2>
            ...
            {/* Title */}
            <div className="mb-4">
              <label className="block text-[14px] font-medium text-[#454545] mb-1 text-start">Title</label>
              <input
                type="text"
            ...
            <div className="grid grid-cols-2 gap-4 mb-4">
              <div >
                <label className="block text-[14px] font-medium text-[#454545] mb-1 text-start">To</label>
              ...
              <div>
                <label className="block text-[14px] font-medium text-[#454545] mb-1 text-start">Select School</label>
                <select className="w-full h-[40px] px-3 border bg-transparent border-[#E6E6E6] rounded-[8px] text-[14px] text-[#000000] font-jakarta outline-none appearance-none">
                  <option>All</option>
